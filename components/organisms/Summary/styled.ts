...
export const ScSummaryContainer = tw.div`w-fit min-h-460 flex flex-col justify-between border-l-2 border-orange-500 pl-20 pt-20 border-opacity-20`;
export const ScSummaryTop = tw.div`flex-grow w-260 h-fit flex flex-col`;
export const ScSummaryBottom = tw.div`w-260 flex-none h-fit pt-13`;
